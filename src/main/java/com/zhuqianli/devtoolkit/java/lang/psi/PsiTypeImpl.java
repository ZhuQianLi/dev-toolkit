...
import com.zhuqianli.devtoolkit.valueobject.JavaPrimitiveType;
...
public class PsiTypeImpl implements JavaType {
    ...
    public boolean isBigDecimal() {
        return Objects.equals(psiType.getCanonicalText(), JavaPrimitiveType.BigDecimal.getCanonicalText());
    }
    ...
    public boolean isPrimitive() {
        return JavaPrimitiveType.CANONICAL_TEXT_MAP.containsKey(psiType.getCanonicalText()) || isEnum();
    }
